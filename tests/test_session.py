...
def test_get_session_with_cache():
    ...
    from data_fetcher.core.session import CachedLimiterSession
...
def test_get_session_without_cache():
    ...
    assert session is not None
    # Check if it's the expected session type
    from data_fetcher.core.session import LimiterSession
...
def test_session_class_naming():
    ...
    from data_fetcher.core.session import CachedLimiterSession, LimiterSession
