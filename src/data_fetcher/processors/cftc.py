"""CFTC data processors.

Utility functions for processing CFTC (Commodity Futures Trading Commission) data.
"""
...
# Column mappings for integer fields
INT_COLUMNS = [
...
# Column mappings for float fields
FLOAT_COLUMNS = [
...
def read_csv(
    ...
    """Read and process CFTC CSV file.

    Args:
        filepath: Path to CFTC CSV file
        target_column: Market name to filter for

    Returns:
        pl.DataFrame: Processed CFTC data with report and release dates
    """
